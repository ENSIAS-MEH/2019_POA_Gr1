...
public class FileDisplayController implements Initializable {
	...
	/**
	 * Méthode pour l'option dans la barre de menu>Fichier>Ouvrir un fichier
	 * On change le fichier csv, et on réaffiche
	 */
	@FXML
	private void ouvrirFichierHandler(ActionEvent e) {
		/*
		 * Possibilité de choisir de choisir un autre fichier,
		 * On refresh la scene courante utilisant le même fichier fxml
		 */
	 ...
	 */
	@FXML
	private void fermerFichierHandler(ActionEvent e) {
